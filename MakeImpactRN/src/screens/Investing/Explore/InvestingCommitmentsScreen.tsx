...
type Props = ReturnType<typeof mapStateToProps> &
  NativeStackScreenProps<RootStackNavigationParamList, 'InvestingCommitments'>;

const InvestingCommitmentsScreen = (props: Props) => {
  const renderedCommitments = props.commitments.map(commitment => {
    return (
      <TouchableNativeFeedback
        onPress={() =>
          props.navigation.navigate('InvestingCommitmentCompanies', {
...
const InvestingCommitmentsScreenConnected = connect(
  mapStateToProps,
  mapDispatchToProps,
)(InvestingCommitmentsScreen);
...
export { InvestingCommitmentsScreenConnected as InvestingCommitmentsScreen };
