...
type Props = ReturnType<typeof mapStateToProps> &
  NativeStackScreenProps<RootStackNavigationParamList, 'CompanyDetailsStocks'>;

const InvestingCompanyDetailsScreen = (props: Props) => {
...
const InvestingCompanyDetailsScreenConnected = connect(
  mapStateToProps,
  mapDispatchToProps,
)(InvestingCompanyDetailsScreen);
...
export { InvestingCompanyDetailsScreenConnected as InvestingCompanyDetailsScreen };
