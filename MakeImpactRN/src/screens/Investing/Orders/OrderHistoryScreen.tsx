...
type Props = ReturnType<typeof mapStateToProps> &
  MaterialTopTabScreenProps<OrdersNavigationParamList, 'Trades'>;
      ...
      <SafeAreaView style={styles.container}>
        <ScrollView
          ...
          {initializing ? (
            ...
            activeOrders
              .sort((a, b) => b.lastExecutionTime_r - a.lastExecutionTime_r)
              .map(order => {
...
const OrderHistoryScreenConnected = connect(
  mapStateToProps,
  mapDispatchToProps,
)(OrderHistoryScreen);
...
export { OrderHistoryScreenConnected as OrderHistoryScreen };
